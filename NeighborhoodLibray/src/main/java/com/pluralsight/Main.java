...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        books[] booksInLibrary = {
                new books(101, "978-0-00-000000-1", "Gotrek & Felix The First Omnibus", false, " "),
                new books(102, "978-0-00-000000-2", "Gotrek & Felix The Second Omnibus", false, " "),
                new books(103, "978-0-00-000000-3", "Gotrek & Felix The Third Omnibus", false, " "),
                new books(104, "978-0-00-000000-4", "Gotrek & Felix The Fourth Omnibus",false,  " "),
                new books(105, "978-0-00-000000-5", "Gotrek & Felix The Fifth Omnibus", false, " "),
                new books(106, "978-0-00-000000-6", "Gotrek & Felix The Sixth Omnibus", false, " "),
                new books(107, "978-0-00-000000-7", "Atomic Habits", false, " "),
                new books(108, "978-0-00-000000-8", "The 5 Resets", false, " "),
                new books(109, "978-0-00-000000-9", "Solve for Happy", false, " "),
                new books(110, "978-0-00-000001-0", "I Will Teach You to Be Rich", false, " "),
                new books(111, "978-0-00-000001-1", "The Psychology of Money", false, " "),
                new books(112, "978-0-00-000001-2", "The Laws of Human Nature", false, " "),
                new books(113, "978-0-00-000001-3", "48 Laws of Power", false, " "),
                new books(114, "978-0-00-000001-4", "Warhammer40k Avenging Son", false, " "),
                new books(115, "978-0-00-000001-5", "Warhammer40k The Gate of Bones", false, " "),
                new books(116, "978-0-00-000001-6", "Warhammer40k The Wolftime", false, " "),
                new books(117, "978-0-00-000001-7", "Warhammer40k Throne of Light", false, " "),
                new books(118, "978-0-00-000001-8", "Warhammer40k The Iron Kingdom", false, " "),
                new books(119, "978-0-00-000001-9", "Warhammer40k The Martyr’s Tomb", false, " "),
                new books(120, "978-0-00-000002-0", "Warhammer40k Sea of Souls", false, " "),
        };
        int choices = 0;
        while (choices != 20) {
    ...
    public static void bookList(books[] Books){
        System.out.println();
    ...
    public static void showCheckOutBooks(books[] booksInLibrary) {
        System.out.println();
        ...
        for (int i = 0; i < booksInLibrary.length ; i++) {
            //System.out.printf("%d \n",booksInLibrary,Books.getisbn,Books.title,Books.checkedOutTo,Books.isCheckedOut);
    ...
    public static void showCheckoutTo(books[] Books)
            //who checked out books and what books they checked out
    {
       ...
       // if (userInput.nextInt() == booksInLibrary.getid ){BooksInLibrary.isCheckedoutTo == false}
        // if (BooksInLibrary.isCheckedOutTo == false {checkedOutTo == ""}
